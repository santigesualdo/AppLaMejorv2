...
-- ----------------------------
--  Procedure definition for `borrarCliente`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `grabarNuevaProveedorCuenta`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `obtenerClientesSaldoActual`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `obtenerMovCuentas`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `obtenerMovCuentasParseado`
-- ----------------------------
...
-- ----------------------------
--  Procedure definition for `obtenerMovCuentasParseadoEntreFechas`
-- ----------------------------
